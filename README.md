...
여러 LLM 제공업체(Google, OpenRouter, Akash, Cohere, Codestral, Qwen, Perplexity, Nvidia NIM, CLI Proxy API)의 OpenAI 호환 API를 **Ollama 호환 API** 및 **OpenAI 호환 API** 형태로 제공하는 프록시 서버입니다.

## 주요 기능

| 기능 | 설명 |
|------|------|
| **다중 제공업체 지원** | 9개 LLM 제공업체를 단일 인터페이스로 사용 |
