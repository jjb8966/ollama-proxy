...
class ChatHandler:
    ...
    PROVIDER_CONFIG = {
        ...
        "qwen": {"base_url": "https://portal.qwen.ai/v1", "client_attr": "qwen_client"},
        "perplexity": {
    ...
    def __init__(self, api_config):
        ...
        self.nvidia_client = StandardApiClient(api_config.nvidia_rotator)
    ...
    def handle_chat_request(self, req: Dict[str, Any]) -> Optional[requests.Response]:
        ...
        return client.post_request(
            url=endpoint, payload=payload, headers=headers, stream=stream
        )
